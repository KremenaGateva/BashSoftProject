    ...
    public class DisplayCommand : Command
    {
        ...
        public override void Execute()
        {
            ...
            if (entityToDisplay.Equals("students", StringComparison.OrdinalIgnoreCase))
            {
                ...
                ISimpleOrderedBag<IStudent> studentsList = this.repository.GetAllStudentsSorted(studentComparator);
            ...
            else if (entityToDisplay.Equals("courses", StringComparison.OrdinalIgnoreCase))
            {
                ...
                ISimpleOrderedBag<ICourse> coursesList = this.repository.GetAllCoursesSorted(courseComparator);
                OutputWriter.WriteMessageOnNewLine(coursesList.JoinWith(Environment.NewLine));
            }
            else
            {
                throw new InvalidCommandException(this.Input);
